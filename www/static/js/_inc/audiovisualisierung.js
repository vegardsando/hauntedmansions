...
function playSong() {
	...
	request.open('GET', $(".visualizer").attr("data-lydfil"), true);
	request.responseType = 'arraybuffer';
...
function updateProgress (oEvent) {
  if (oEvent.lengthComputable) {
	...
	$("#loading").html("Loading music... " + Math.floor(percentComplete * 100) + "%");
  } else {
...
function drawBars (array) {
	...
	ctx.scale(1, 1);
	ctx.translate(window.innerWidth /2 , window.innerHeight +300);
	ctx.fillStyle = "#fff";
